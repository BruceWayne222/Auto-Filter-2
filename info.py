...
PICS = (environ.get('PICS', 'https://telegra.ph/file/b91507b352fe7d8cf7956.jpg https://telegra.ph/file/b91507b352fe7d8cf7956.jpg')).split()
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MHSLsupport')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "True")), True)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<code>{file_name}</code>\n\n<b>Size:</b> {file_size}\n\n<b>Join [Movie Hub SL🎬](https://t.me/MovieHub_SL) for more Movies </b>")
